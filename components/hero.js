        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              ...
              <Mark>
                {" "}
                proof of concept prototyping to final production embedded
                software design, we are experts in Bluetooth projects{" "}
              </Mark>
              ; that’s why we’re recommended by industry leaders such as Nordic
              and Avnet AVID. PSL has partnerships with experts in various
              disciplines, ensuring a full product development experience for
              your project.
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by{" "}
            <span className="text-[#FF8360]">customers worldwide</span> .
          </div>
