  ...
  return (
    <div>
      <Disclosure>
        {({ open }) => (
          <>
            <Disclosure.Button className="fixed z-40 flex items-center justify-center transition duration-300 bg-[#00DCFF] rounded-full shadow-lg right-5 bottom-5 w-14 h-14 focus:outline-none hover:bg-[#00B5d1] focus:bg-[#00B5d1] ease">
            ...
            >
              <Disclosure.Panel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-300 dark:border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                ...
                <div className="flex flex-col items-center justify-center h-32 p-5 bg-[#00DCFF]">
                  ...
                  <p className="text-white opacity-80">We usually respond in a few hours</p>
                </div>
                ...
                <div className="flex-grow h-full p-6 overflow-auto bg-gray-50 ">
                  {!isSubmitSuccessful && (
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      <input type="hidden" value="200ec58f-1019-45ba-bff5-0bfb685836ab" {...register("apikey")} />
                      <input type="hidden" value={`${userName} sent a message from PSL`} {...register("subject")} />
                      <input type="hidden" value="Pretty Smart Labs Info" {...register("from_name")} />
                      ...
                      {/* Company block */}
                      <div className="mb-4">
                        <label htmlFor="full_company" className="block mb-2 text-sm text-gray-600 dark:text-gray-400">
                          Company
                        </label>
                        <input
                          type="text"
                        ...
                        />
                        {errors.company && <div className="mt-1 text-sm text-red-400 invalid-feedback">{errors.company.message}</div>}
                      </div>
                      ...
                      <div className="mb-3">
                        <button
                          type="submit"
                          className="w-full px-3 py-4 text-white bg-[#00DCFF] rounded-md focus:bg-[#00DCFF] focus:outline-none"
                        >
                          {isSubmitting ? (
                            <svg
                      ...
                      <p className="text-xs text-center text-gray-400" id="result">
                        <span>
                          Powered by{" "}
                          <a href="" className="text-gray-600" target="_blank" rel="noopener noreferrer">
                            PSL
                          </a>
                        </span>
                      </p>
